...
public class OrderConfirmed extends Fragment {
    ...
    TextView mOrderIdTv, mSelectedPharmacyTv, mDeliveryDateTv, mTotalCostTv, mNoOfItemsTv;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mNoOfItemsTv = view.findViewById(R.id.no_of_items_tv);
        ...
        mNoOfItemsTv.setText(String.valueOf(mAdapter.getItemCount()));
